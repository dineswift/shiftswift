...
echo "  Tenant app  http://localhost:${FRONTEND_PORT}/tenant.html"
echo "  Landlord    http://localhost:${FRONTEND_PORT}/landlord.html"
echo "  API docs    http://localhost:${BACKEND_PORT}/docs"
echo "  Agency      agency@swiftcrm.local / Lettings-Demo-2026"
echo "  Tenant      hannah.reid@example.com / Tenant-Demo-2026"
echo "  Landlord    priya@mapperleyholdings.example / Landlord-Demo-2026"
echo ""
